document.addEventListener("DOMContentLoaded", function () {
  ...
  const editContactSuccessToast = document.getElementById("editContactSuccessToast");
  const successToastBootstrap = bootstrap.Toast.getOrCreateInstance(editContactSuccessToast);
